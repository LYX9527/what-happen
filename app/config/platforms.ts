...
export const ROUTE_CONFIGS: Record<string, RouteConfig> = {
  ...
  tech: {
    ...
    platforms: ['github', '_36kr', 'ithome', 'solidot', 'v2ex', 'coolapk', 'juejin', 'sspai', 'csdn'],
    category: 'tech'
  },
  ...
  social: {
    ...
    platforms: ['thepaper', 'cankaoxiaoxi', 'zaobao', 'sputniknewscn'],
    category: 'social'
  },
  ...
  index: {
    ...
    platforms: ['weibo', 'baidu', 'github', '_36kr', 'thepaper', 'gelonghui'],
    category: 'index'
  }
}
